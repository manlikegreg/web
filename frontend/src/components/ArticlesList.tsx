  ...
  return (
    <section className="section-padding bg-white">
      <div className="container-custom">
        <StaggerAnimation className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" staggerDelay={0.1}>
          {articles.map((article, index) => (
            ...
            >
              <div className="aspect-w-16 aspect-h-9 overflow-hidden relative">
                ...
                >
                  <span className="inline-block px-3 py-1 bg-white/90 backdrop-blur-sm text-primary-700 rounded-full text-xs font-medium shadow-lg">
                    {article.category}
                  </span>
                </motion.div>
              </div>
              ...
              <div className="p-6">
                ...
                <motion.h3 
                  className="text-xl font-semibold text-secondary-900 mb-3 group-hover:text-primary-600 transition-colors line-clamp-2"
                  whileHover={{ x: 5 }}
                  transition={{ duration: 0.2 }}
                >
                  {article.title}
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {article.tags.slice(0, 3).map((tag, idx) => (
                    <motion.span
                      key={idx}
                      className="inline-block px-2 py-1 bg-secondary-100 text-secondary-600 text-xs rounded"
